        ...
        switch (mode) {
            ...
            case 4: {
                ...
                gesture = get_int("\e[0;35m\n"
                                    ...
                                    "'3' for water\n'4' for fire\n'5' for sponge\n"
                                    "'6' for air\n'7' for human\n'8' for gun\n"
                                    "'9' for wolf\n'10' for Ḑ̷̮̳̣̟͉͋͗̓̕͜ë̸͓̮͉͈͇͍̖͎̩̞͈́́́̋̇̾͋̈́̾͆͑͘͘͜͠͝ṽ̵͇̟̺̣͓̰̭̲̼̻̪̩̰͒̓̿̄̾̔̊͝ͅi̶̡̹͈͎̳̞͙͖̾̂̀͑̀͆̑̓̽̉͐͘͘ͅl̶̬̞͎̖͉̹̝͕̝͖̣̉͆\n\e[0m\n");
                break;
            }
            default: {
    ...
    printf(" \e[0;37mand \e[1;92mYou \e[0;37mchose\e[1;92m ");
        ...
        switch (computer) {
            ...
            case 9:
                ...
                break;
            case 10:
                printf("Ḑ̷̮̳̣̟͉͋͗̓̕͜ë̸͓̮͉͈͇͍̖͎̩̞͈́́́̋̇̾͋̈́̾͆͑͘͘͜͠͝ṽ̵͇̟̺̣͓̰̭̲̼̻̪̩̰͒̓̿̄̾̔̊͝ͅi̶̡̹͈͎̳̞͙͖̾̂̀͑̀͆̑̓̽̉͐͘͘ͅl̶̬̞͎̖͉̹̝͕̝͖̣̉͆ (10)");
                break;
        }
